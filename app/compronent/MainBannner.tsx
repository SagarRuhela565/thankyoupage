import bgImg from '../assets/images/bg-img-1.webp';
const MainBannner = () => {
    return (
        <section className="relative bg-white py-[5rem]">
            <div className="absolute inset-0 opacity-[0.48] pointer-events-none z-0">
                <img
                    src={bgImg.src}
                    alt=""
            ...
            <div className=" max-w-[1280px] mx-auto px-4 lg:px-8">
                <div className="py-2 text-center">
                    ...
                    <p className="text-[18px] text-[#000]">
                        ENTER YOUR ZIP CODE TO FIND THE BEST HEALTH INSURANCE PLAN NOW 👇
                    </p>
                </div>
